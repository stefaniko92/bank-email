...
3. **Auth** – Workload Identity Federation (OIDC), no keys. See [Vercel GCP OIDC](https://vercel.com/docs/oidc/gcp). Enable OIDC in Vercel Project Settings.
...
5. Set in Vercel environment:
   ```env
   GCP_PROJECT_NUMBER=...
   GCP_SERVICE_ACCOUNT_EMAIL=...@project.iam.gserviceaccount.com
